...
<body>
<h3>Thêm Nhà Hàng</h3>
<html:form action="/themNhaHang.do">
<table>
	<tr>
		<td>
		Mã Nhà Hàng
		...
		<td>
		<html:text property="maNhaHang" name="nhaHangForm"></html:text>
		</td>
	</tr>
	<tr>
		<td>
...
<html:optionsCollection name="nhaHangForm" property="listKhuVuc" value="maKhuVuc" label="tenKhuVuc"></html:optionsCollection>
		...
		<td>
		<html:text property="moTa" name="nhaHangForm"></html:text>
		</td>
	</tr>
	<tr>
		<td colspan="2">
		<html:submit value="Them" property="them"></html:submit>
